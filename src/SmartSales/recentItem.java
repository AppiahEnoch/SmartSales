...
@FXML
    ...
    void editPrice(TableColumn.CellEditEvent editEvent) {
        ...
        Object id = colSelected1.getId();
        updateItemName("price", n, id);

    }


    public void updateItemName(String column, Object newName, Object id) {
        DBcon();
